        ...
        <>
            ...
            <header className="heronoimage" id="hero">
                <div className="container">
                    <h1 className="animated fadeInDown delay-07s">School Robotics Clubs</h1>
                </div>
            </header>
            ...
            <section className="main-section alabaster" id="pricing">
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-12 text-center wow fadeInUp delay-04s mt-4">
            ...
            <section className="main-section" id="cta">
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-12 wow fadeInUp delay-04s">
