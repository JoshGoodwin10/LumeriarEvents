        ...
        <>
            ...
            <header className="heronoimage" id="hero">
                <div className="container">
                    <h1 className="animated fadeInDown delay-07s">Contact Us</h1>
                </div>
            </header>

            {/* Contact Section */}
            <section className="main-section alabaster wow fadeInUp" id="contact">
                <div className="container">
                    <div className="row align-stretch">
                        <div className="col-2">
                            <div className="contact-form text-center wow fadeInUp delay-04s">
                                <iframe
                        ...
                        <div className="col-2">
                            <div className="contact-map wow fadeInRight delay-04s">
                                <iframe
            ...
            {/* Contact Details */}
            <section className="main-section wow fadeInUp" id="contact-details">
