...
export default function RequestsDashboard() {
    ...
    const load = useCallback(async () => {
        setLoading(true);
        try {
            const data = await fetchTeamRequests({
                search: search || undefined,
                is_approved: showApproved
            });
            setRequests(data);
        } catch (err) {
            console.error(err);
    ...
    const displayCount = showApproved ? requests.length : pendingCount;
        ...
        <div className="td-root">
            <div className="td-header">
                <div>
                    ...
                    <p className="td-subtitle">
                        {displayCount} {showApproved ? "request(s)" : "pending request(s)"}
                    </p>
                </div>
            </div>
            ...
            <div className="td-filters">
                <div className="filter-search">
                    ...
                    <input
                        type="text"
                        placeholder="Search team name or province…"
                        value={search}
